...
export default function HomePage() {
  return (
    <main className="min-h-screen relative overflow-hidden flex flex-col items-center justify-center p-6 bg-[#0b0f19] text-slate-100">
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-orange-500/15 rounded-full blur-3xl pointer-events-none animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-yellow-500/10 rounded-full blur-3xl pointer-events-none" />

      <div className="relative z-10 max-w-4xl w-full text-center space-y-8 animate-fade-in">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/30 text-orange-400 text-xs font-bold tracking-wider uppercase shadow-inner mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 max-w-3xl mx-auto">
          ...
          <Link
            href="/participant"
            className="group relative bg-slate-900/80 backdrop-blur-xl p-8 rounded-2xl flex flex-col items-start text-left border border-slate-800 hover:border-orange-500/60 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-500/15 hover:-translate-y-1.5"
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-t-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
            <div className="w-12 h-12 rounded-xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center text-orange-400 mb-5 group-hover:scale-110 transition-transform">
            ...
            <div className="mt-6 inline-flex items-center gap-2 text-xs font-bold text-orange-400 group-hover:translate-x-1 transition-transform">
              Enter Study Module →
            </div>
          </Link>
