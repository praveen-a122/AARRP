export const theme = {
  ...
  classes: {
    ...
    buttonPrimary: 'bg-gradient-to-r from-primary to-orange-600 hover:from-primary/90 hover:to-orange-500 text-white font-medium py-2.5 px-5 rounded-lg shadow-lg shadow-orange-500/25 transition-all duration-200 active:scale-95 flex items-center justify-center gap-2',
